...
The page "$1" doesn\'t exist yet. You can still add files and links, but no subpages (for technical reasons). You may want to ',
		...
		'subpage_exp' => 'If you want to develop a resource directly in this wiki, you should add a subpage. Enter a \'\'meaningfull\'\' title in the input field below and click "$1" to get directly to that subpage.',
